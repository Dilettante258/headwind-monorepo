...
- **Auto Format** — Transformed code is automatically formatted using your default formatter; empty lines and comments are preserved
  自动格式化 — 转换后的代码会自动使用默认格式化器格式化，空行和注释均会保留
